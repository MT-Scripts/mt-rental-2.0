...
Config.BillingAfterMailTime = 5 -- Time to receive bill after receive mail to take vehicle back (in minutes)
Config.FeesPrice = 1000 -- The fees price that player recive when not take vehicle at time
...
Config.RentalSpots = {
    ["Rental1"] = {
        ...
        ["AvailableVehicles"] = {
            [1] = { VehicleSpawnName = "neon", VehicleLableName = "Pfister Neon", RentPrice = 100, MenuIcon = "fas fa-car" },
            [2] = { VehicleSpawnName = "calico", VehicleLableName = "Karin Calico", RentPrice = 1000, MenuIcon = "fas fa-car" },
            [3] = { VehicleSpawnName = "sultan", VehicleLableName = "Karin Sultan", RentPrice = 500, MenuIcon = "fas fa-car" },
            [4] = { VehicleSpawnName = "shinobi", VehicleLableName = "Nagasaki Shinobi", RentPrice = 300, MenuIcon = "fas fa-motorcycle" },
            [5] = { VehicleSpawnName = "sultan3", VehicleLableName = "Karin Sultan Classic", RentPrice = 150, MenuIcon = "fas fa-car" },
        },
    },
}
